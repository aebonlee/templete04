...
| 템플릿 | 콘셉트 | 특징 |
|--------|--------|------|
| [**Raycast Pro**](./raycast-pro/) | 런처 · 제품 (실제 사이트 재현) | 실제 raycast.com 마크업 기반 풀 재현 — 로고 SVG, WebGL 붉은 유리 배경, 커맨드바 런처 목업, 확장·AI·후기·커뮤니티·API·뉴스레터 |
| [**Raycast**](./raycast/) | 런처 · 제품 (고충실도 클론) | 커맨드바 UI 목업, 확장 그리드, AI 섹션, 시그니처 레드(#FF6363), 세로 광선 |
| [**Frost**](./raycast-frost/) | 라이트 · 프로스트 글래스 | 파스텔 오로라 메시 + 프로스트 글래스 카드, 인디고(#6C5CE7) 액센트, Apple 감성의 밝은 테마 |
| [**Mono**](./raycast-mono/) | 에디토리얼 · 모노크롬 | 스위스 그리드 · 헤어라인 룰 · 대형 세리프 디스플레이, 단일 크림슨(#E5484D) 액센트 |
| [**Neon**](./raycast-neon/) | 사이버펑크 · 네온 | 순수 블랙 위 네온 시안/마젠타 글로우, 테크 그리드 + 스캔라인, 모노스페이스 |
| [**Sunset**](./raycast-sunset/) | 바이브런트 · 그라디언트 | 오렌지→핑크→바이올렛 애니메이션 선셋 그라디언트, 둥글고 활기찬 웜톤 |
| [**Teams**](./raycast-teams/) | 협업 · 엔터프라이즈 | raycast.com/teams 영감 — 공유 스니펫·프라이빗 스토어·3단 요금제, 레드+바이올렛(#7C6BFF) |
